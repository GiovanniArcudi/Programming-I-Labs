...
public class WordGroup {
    ...
    /**
     * Creates an HashMap<String,Integer>, then Loops over all the words returned by {@link #getWordArray()} and puts each
     * word into the HashMap with the number of times it occurs, and finally returns the HashMap<String, Integer>.
     */
