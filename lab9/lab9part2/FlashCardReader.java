...
public class FlashCardReader {
    private BufferedReader reader;                      // The buffered rreader of the Flash Card Reader Class.
    ...
    /**
     * This is the Flash Card Reader class constructor.
     *
    ...
    public String getLine() {
        ...
        // Reads the next line and returns it. If an I/O error occurs it catches the IOException and prints the error.
        try {
    ...
    public ArrayList<FlashCard> getFlashCards() {
        ...
        /* Reads each line of the input file and, if it is != null, splits it in question and answer and stores it as a
